      ...
      <main style={S.main}>
        ...
        <section style={{ ...S.panel, ...S.footerPanel }}>
          ...
          <ul style={S.footerList}>
            ...
            <li>Prezzi verificati su annunci reali entro 200km da Padova per 12 dei {MODELS.length} modelli. I 4 aggiunti il 20/08/2026 (Yaris standard, Fiat 600, C3 Aircross, Mokka) hanno dati più deboli: prezzi in parte stimati, e per Fiat 600, C3 Aircross e Mokka le stelle Euro NCAP non sono state verificate con una fonte diretta — vedi la nota su ciascuna card. Ricontrolla comunque prima di un acquisto: gli annunci usati cambiano nel giro di poche settimane.</li>
